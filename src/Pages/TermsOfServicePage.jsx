  ...
  return (
    <div className="policy-container">
      <div className="policy-content">
        ...
        <div className="policy-section">
          <h2 className="section-title">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h2>
        ...
        <div className="policy-section">
          ...
          <p>
            ...
            Services that we offer. All descriptions of products or product pricing are subject to change at anytime without notice, at the 
        ...
        <div className="policy-section">
          <h2 className="section-title">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h2>
          <p>
            ...
            was made. We reserve the right to limit or prohibit orders that, in our sole judgment, appear to be placed by dealers, resellers or 
            distributors.
          </p>
          <p>
        ...
        <div className="policy-section">
          ...
          <p>
            Any use by you of the optional tools offered through the site is entirely at your own risk and discretion and you should ensure 
        ...
        <div className="policy-section">
          ...
          <p>
            Third-party links on this site may direct you to third-party websites that are not affiliated with us. We are not responsible for 
            examining or evaluating the content or accuracy and we do not warrant and will not have any liability or responsibility for any 
        ...
        <div className="policy-section">
          <h2 className="section-title">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h2>
          <p>
        ...
        <div className="policy-section">
          <h2 className="section-title">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h2>
          <p>
            ...
            information in the Service or on any related website is inaccurate at any time without prior notice (including after you have submitted 
            your order).
          </p>
          <p>
        ...
        <div className="policy-section">
          ...
          <p>
            ...
            or (k) to interfere with or circumvent the security features of the Service or any related website, other websites, or the Internet. We 
            reserve the right to terminate your use of the Service or any related website for violating any of the prohibited uses.
          </p>
        </div>

        <div className="policy-section">
          <h2 className="section-title">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h2>
          <p>
          ...
          <p>
            ...
            products procured using the Service, or for any other claim related in any way to your use of the Service or any product, including, but 
            not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the Service 
            or any content (or product) posted, transmitted, or otherwise made available via the Service, even if advised of their possibility. Because 
            some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such 
        ...
        <div className="policy-section">
          ...
          <p>
            ...
            agreement and understanding between you and us and governs your use of the Service, superseding any prior or contemporaneous agreements, 
        ...
        <div className="policy-section">
          <h2 className="section-title">SECTION 19 - CHANGES TO TERMS OF SERVICE</h2>
          <p>
          ...
          <p>
            ...
            changes to our website. It is your responsibility to check our website periodically for changes. Your continued use of or access to our 
