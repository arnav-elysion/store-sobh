    ...
    <div className="policy-container">
      <div className="policy-content">
        ...
        <section>
          <h2>Introduction</h2>
          <p>
            This Privacy Policy describes how Man Jewels (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from store.manjewels.in (the "Site") or otherwise communicate with us regarding the Site (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
          </p>
          <p>
        ...
        <section>
          <h2>Contact Us</h2>
          <p>
            Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at support@manjewels.in or contact us at Level 3 and Level 4, BPTP Centra One, Golf Course Ext Rd, Sector 61, Gurugram, Haryana 122102, IN.
          </p>
        </section>
